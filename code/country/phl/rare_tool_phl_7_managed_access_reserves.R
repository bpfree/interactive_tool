...
managed_access_dir <- "data\\country\\phl\\a_raw_data\\managed_access_areas"
reserve_dir <- "data\\country\\phl\\a_raw_data\\existing_reserve"
...
ma <- phl_ma %>%
  ...
  dplyr::rename(region = PROVNAME, maa = MUNNAME, ma_area = Area_ha)
