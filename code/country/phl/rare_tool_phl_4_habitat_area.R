...
eez_dir <- "data\\country\\phl\\b_clean_data"

habitat_area_dir <- "data\\country\\phl\\a_raw_data\\habitat_area"

mangrove_dir <- "data\\country\\phl\\a_raw_data\\mangrove"
coral_dir <- "data\\country\\phl\\a_raw_data\\coral_reef"
seagrass_dir <- "data\\country\\phl\\a_raw_data\\seagrass"

## 1b. setting output directories
clean_dir <- "data\\country\\phl\\b_clean_data"
analyze_dir <- "data\\country\\phl\\c_analyze_data"
...
head(antique_habitat_area)
head(camotes_habitat_area)
head(escalante_habitat_area)
head(siargao_habitat_area)
...
crs(antique_habitat_area)
crs(camotes_habitat_area)
crs(escalante_habitat_area)
crs(siargao_habitat_area)
